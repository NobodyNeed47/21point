...
{
	ShowMessage("Написать программу, рассчитанную на активное взаимодействие с пользователем посредством графического интерфейса. За основу берётся правила игры в 21 очко. Создание и сохранение результатов в аккаунты пользователей которые записываются в файлы. Показывать визуально ход и результат игры.");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::N4Click(TObject *Sender)
{
	ShowMessage("Программа создана для проигрывания ситуации игры в 21 очко.\nКнопки взаимодейсвтия с аккаунтами пользователей, а именно <Авторизация>,<Регистрация>,<Выйти из учётной записи>\nКнопки <Главное меню> для перехода в главное меню.\nКнопок <Новая игры>, <Начать игру> для запуска процесса игры.\nКнопки <Взять карту> чтобы игрок брал карту в свою руку.\nКнопки <Раскрыть карты> для передачи хода компьютеру и подсчёта результата игры");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::N5Click(TObject *Sender)
{
	ShowMessage("Beta 1.1\nДата изменения: 28.05.2022\nАвтор:Артемьев Дмитрий");
}
//---------------------------------------------------------------------------
